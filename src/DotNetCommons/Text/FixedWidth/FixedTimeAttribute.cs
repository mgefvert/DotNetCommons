...
public class FixedTimeAttribute : FixedWidthAttribute
{
    public string Format { get; set; } = "HHmmss";

    public FixedTimeAttribute(int start, int length) : base(start, length)
    {
    }
