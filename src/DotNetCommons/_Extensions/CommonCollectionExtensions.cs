...
public static class CommonCollectionExtensions
{
    ...
    public static void LinkToOne<TSource, TTarget, TKey>(this ICollection<TSource> source, ICollection<TTarget> target,
    ...
    /// <param name="targetSelector">Selector for the index key in the target list</param>
    /// <param name="assign">Assignment function that lets the caller perform the linking by assigning the target object to the source</param>
    public static void LinkToMany<TSource, TTarget, TKey>(this ICollection<TSource> source, ICollection<TTarget> target,
