...
namespace DotNetCommons.WinForms.Graphics
{
    ...
    public sealed class NativeTextRenderer : IDisposable
    {
        ...
        /// Init.
        /// </summary>
        public NativeTextRenderer(System.Drawing.Graphics graphics)
        {
            _graphics = graphics;
        ...
        public void DrawTransparentText(string str, Font font, Color color, Point point, Size size)
        {
            ...
            var dib = CreateDIBSection(_hdc, ref info, 0, out _, IntPtr.Zero, 0);
        ...
        /// <summary>
        /// Release current HDC to be able to use <see cref="DotNetCommons.WinForms.Graphics"/> methods.
        /// </summary>
        public void Dispose()
        {
            if (_hdc == IntPtr.Zero)
        ...
        private static IntPtr GetCachedHFont(Font font)
        {
            ...
            if (FontsCache.TryGetValue(font.Name, out var dic1))
            {
